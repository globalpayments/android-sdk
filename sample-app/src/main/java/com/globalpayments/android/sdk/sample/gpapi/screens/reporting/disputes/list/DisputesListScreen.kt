...
fun DisputesListScreen(
    ...
    vm: DisputesListViewModel = viewModel()
) {
    ...
    Column(
        ...
        if (screenModel.responses.isEmpty()) {
            DisputesListParams(viewModel = vm)
        } else {
            DisputesListResponse(viewModel = vm)
        }
        ...
        GPSnippetResponse(
            ...
            codeSampleLocation = buildAnnotatedString {
                withStyle(
                    ...
                    append("Find the code below in this files: sample/gpapi/screens/reporting/disputes/list/")
                }
                withStyle(
                    SpanStyle(
                        color = Color(0xFF5A5E6D),
                    ...
                    append("DisputesListViewModel.kt")
                }
            },
            codeSampleSnippet = R.drawable.snippet_report_dispute_list,
