...
fun GPEcom3DSScreen(
    ...
    vm: GPEcom3DSViewModel = viewModel(initializer = { GPEcom3DSViewModel(context) })
) {
    ...
    Column(
        ...
        GPScreenTitle(
            modifier = Modifier,
            title = stringResource(id = R.string.ecom_threeds),
        )

        Text(
            modifier = Modifier.padding(top = 11.dp),
            text = stringResource(id = R.string.ecom_threeds_long_description),
            fontSize = 14.sp,
            ...
            GPSnippetResponse(
                ...
                codeSampleLocation = buildAnnotatedString {
                    withStyle(
                        ...
                        append("Find the code below in this files: sample/gpapi/screens/processpayment/gpecom3ds/")
                    }
                    withStyle(
                        SpanStyle(
                            color = Color(0xFF5A5E6D),
                        ...
                        append("\nGPEcom3DSViewModel.kt")
                    }
                },
                codeSampleSnippet = R.drawable.snippet_gpecom_netcetera,
