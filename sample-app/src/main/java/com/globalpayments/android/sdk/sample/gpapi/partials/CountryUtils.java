package com.globalpayments.android.sdk.sample.gpapi.partials;
...
public class CountryUtils {
    ...
    public static Map<String, String> countryCodeMapByCountry;
    public static Map<String, String> countryMapByCountryCode;
    public static Map<String, String> countryCodeMapByNumericCode;
    public static Map<String, String> numericCodeMapByCountryCode;
