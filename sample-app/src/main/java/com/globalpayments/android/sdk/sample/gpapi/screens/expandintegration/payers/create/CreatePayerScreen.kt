...
@Composable
fun CreatePayerScreen(createPayerScreenViewModel: CreatePayerScreenViewModel = viewModel()) {
    ...
    Column(
        ...
        val screenModel by createPayerScreenViewModel.screenModel.collectAsState()
        ...
        if (sampleModel == null) {
            ...
            GPInputField(
                ...
                onValueChanged = createPayerScreenViewModel::onFirstNameChanged,
            ...
            GPInputField(
                ...
                onValueChanged = createPayerScreenViewModel::onLastNameChanged,
                keyboardOptions = KeyboardOptions(imeAction = ImeAction.Next)
            )
            ...
            GPSubmitButton(
                ...
                onClick = {
                    softInput?.hide()
                    createPayerScreenViewModel.createPayer()
                }
            )
        } else {
            GPSampleResponse(
            ...
            GPActionButton(
                modifier = Modifier
                    ...
                    .fillMaxWidth(),
                title = "Reset",
                onClick = createPayerScreenViewModel::resetScreen
            )
        }
        ...
        GPSnippetResponse(
            ...
            codeSampleLocation = buildAnnotatedString {
                withStyle(
                    ...
                    append("Find the code below in this files: sample/gpapi/screens/expandintegration/payers/create/")
                }
                withStyle(
                    SpanStyle(
                        color = Color(0xFF5A5E6D),
            ...
            codeSampleSnippet = R.drawable.snippet_payer_create,
