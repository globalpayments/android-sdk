...
fun TransactionsListScreen(
    ...
    vm: TransactionsListViewModel = viewModel(),
) {
    ...
    Column(
        ...
        if (screenModel.responses.isEmpty()) {
            TransactionListParams(viewModel = vm)
        } else {
            TransactionListResponse(viewModel = vm)
        }
        ...
        GPSnippetResponse(
            ...
            codeSampleLocation = buildAnnotatedString {
                withStyle(
                    ...
                    append("Find the code below in this files: sample/gpapi/screens/reporting/transactions/list/")
                }
                withStyle(
                    SpanStyle(
                        color = Color(0xFF5A5E6D),
                    ...
                    append("TransactionsListViewModel.kt")
                }
            },
            codeSampleSnippet = R.drawable.snippet_report_transaction_list,
