...
@Composable
fun ActionsSingleScreen(modifier: Modifier = Modifier, vm: ActionsSingleViewModel = viewModel()) {
    Column(modifier = modifier.fillMaxWidth()) {
        ...
        GPInputField(
            modifier = Modifier
                .padding(top = 20.dp)
                .fillMaxWidth(),
            title = R.string.action_id,
            value = screenModel.actionId,
            onValueChanged = vm::onActionIdChanged,
        ...
        GPSubmitButton(
            modifier = Modifier
                .padding(top = 20.dp)
                .fillMaxWidth(),
            title = stringResource(R.string.report_get_action_by_id),
            ...
            GPSnippetResponse(
                ...
                codeSampleLocation = buildAnnotatedString {
                    withStyle(
                        ...
                        append("Find the code below in this files: sample/gpapi/screens/reporting/actions/single/")
                    }
                    withStyle(
                        SpanStyle(
                            color = Color(0xFF5A5E6D),
                        ...
                        append("ActionsSingleViewModel.kt")
                    }
                },

                codeSampleSnippet = R.drawable.snippet_report_actions_single,
