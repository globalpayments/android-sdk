...
fun AccountsListScreen(
    ...
    vm: AccountsListViewModel = viewModel()
) {
    ...
    Column(
        ...
        val responses = screenModel.responses
        if (responses == null) {
            AccountsListParams(viewModel = vm)
        } else {
            AccountsListResponse(responses, vm::loadMore, vm::resetAccountsList)
        }
        ...
        GPSnippetResponse(
            ...
            codeSampleLocation = buildAnnotatedString {
                withStyle(
                    ...
                    append("Find the code below in this files: sample/gpapi/screens/reporting/accounts/list/")
                }
                withStyle(
                    SpanStyle(
                        color = Color(0xFF5A5E6D),
                    ...
                    append("AccountsListViewModel.kt")
                }
            },
            codeSampleSnippet = R.drawable.snippet_accounts_list,
